            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 pb-20">
              ...
              >
                ...
                <p className="text-secondary-text text-sm max-w-xs mx-auto">
                  Ensure the item is clearly visible and centered for best
                  results.
                </p>
              </motion.div>
            </div>
        ...
        {result && !showDetailsModal && (
          ...
          >
            ...
            >
              ...
              <div
                className={`absolute top-0 inset-x-0 h-40 bg-gradient-to-b ${result.match ? "from-primary/10" : "from-zinc-500/10"} to-transparent pointer-events-none`}
              />
                ...
                <div className="flex items-center gap-5 p-4 rounded-2xl bg-btn-bg/50 border border-border-custom/50">
                  ...
                  <div>
                    ...
                    <p className="text-base font-semibold text-foreground">
                      {formatDate(itemDetails.timestamp).day}{" "}
