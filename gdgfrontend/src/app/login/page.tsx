    ...
    <div className="bg-black min-h-screen overflow-hidden">
      <div className="relative min-h-screen animate-fadeIn">
        ...
        <div className="absolute top-0 left-0 right-0 h-[70vh]">
          ...
          {/* Seamless fade into black */}
          <div className="absolute bottom-0 left-0 right-0 h-[45vh] bg-gradient-to-b from-transparent via-black/60 to-black" />
        </div>

        {/* CONTENT LAYER (full screen) */}
        <div className="relative min-h-screen flex flex-col justify-end pb-24 px-6 z-10">
